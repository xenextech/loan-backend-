...
export const SATISFACTORY_PERFORMANCE_ABOVE3YRS_WEIGHT = 1;
export const SATISFACTORY_PERFORMANCE_ABOVE3YRS_POINT = 1;

export const SATISFACTORY_PERFORMANCE_FROM1_TO3YRS_WEIGHT = 1;
export const SATISFACTORY_PERFORMANCE_FROM1_TO3YRS_POINT = 2;

export const SATISFACTORY_PERFORMANCE_BELOW1YR_WEIGHT = 1;
export const SATISFACTORY_PERFORMANCE_BELOW1YR_POINT = 3;
