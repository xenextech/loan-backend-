...
import {
  ...
  SATISFACTORY_PERFORMANCE_above3Years_POINT,
  SATISFACTORY_PERFORMANCE_above3Years_WEIGHT,
  SATISFACTORY_PERFORMANCE_below1Year_POINT,
  SATISFACTORY_PERFORMANCE_below1Year_WEIGHT,
...
export const CREDIT_PARAMETERS: CreditParameters = {
  ...
  satisfactoryPerformance: {
    above3Years: {
      weight: SATISFACTORY_PERFORMANCE_above3Years_WEIGHT,
      point: SATISFACTORY_PERFORMANCE_above3Years_POINT,
      get weightScore() {
        return this.weight * this.point;
      },
    },
    ...
    below1Year: {
      weight: SATISFACTORY_PERFORMANCE_below1Year_WEIGHT,
      point: SATISFACTORY_PERFORMANCE_below1Year_POINT,
      get weightScore() {
        return this.weight * this.point;
      },
    },
